...
void build_qp_attr(struct ibv_qp_init_attr *qp_attr)
{
    ...
    qp_attr->qp_type = IBV_QPT_RC;// realible connection
...
void post_send(struct rdma_cm_id *id)
{
    ...
    snprintf(conn->send_region, BUFFER_SIZE, "message from server side with pid %d at %s ", getpid(), asctime(gmtime(&timep)) );
